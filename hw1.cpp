...
int main()
{
  ...
  cout << Token(NEG, "neg", 2, 6).to_string() << endl;  
  // logical operators
  ...
  cout << Token(IMPORT, "import", 5, 64).to_string() << endl;    
  cout << Token(FROM, "from", 5, 70).to_string() << endl;    
  cout << Token(AS, "as", 5, 72).to_string() << endl;    
  // primitive types
